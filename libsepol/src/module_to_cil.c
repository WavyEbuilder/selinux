...
static int semantic_level_to_cil(struct policydb *pdb, int sens_offset,
...
static int cond_expr_to_cil(int indent, struct policydb *pdb,
			    struct cond_expr *cond_expr, uint32_t flags)
{
	int rc = 0;
